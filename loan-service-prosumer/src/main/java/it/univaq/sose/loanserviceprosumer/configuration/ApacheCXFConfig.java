...
/**
 * Configures Apache CXF for the Loan Service (Prosumer) application.
...
public class ApacheCXFConfig {
    ...
    public OpenApiFeature createOpenApiFeature() {
        ...
        openApiFeature.setTitle("Loan Service (Prosumer) for Banking Micro-SOA System");
        openApiFeature.setContactName("The Banking Micro-SOA System team");
        openApiFeature.setDescription("This is Loan Service (Prosumer) for Banking Micro-SOA System. Uses Apache CXF and Spring Boot on JAX-RS.");
